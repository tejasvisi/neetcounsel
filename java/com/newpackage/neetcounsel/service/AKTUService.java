...
public class AKTUService {
	...
	public byte[] generateAndSaveAKTUPDF(AKTUdto ob) {
		...
		AktuRequest aktuRequest=new AktuRequest(nirf,placement,recommended,userID,filename);
		byte[] pdfBytes =pdfClient.generateAktuPdf(aktuRequest);
				// pdfService.createAktuPDF(nirf,placement,recommended);
