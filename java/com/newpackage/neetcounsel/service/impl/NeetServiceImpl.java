...
import com.newpackage.neetcounsel.service.PdfClient;
...
public class NeetServiceImpl implements NeetService{
    ...
    public byte[] generateAndSaveNeetPDF(FormDetails ob) {
        ...
        NeetRequest neetRequest=new NeetRequest(result,userID,filename);
        byte[] pdfBytes = pdfClient.generateNeetPdf(neetRequest);//pdfService.createNeetPDF(result);
