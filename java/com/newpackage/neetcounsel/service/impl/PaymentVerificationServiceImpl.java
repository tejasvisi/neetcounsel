...
public class PaymentVerificationServiceImpl implements PaymentVerificationService {
 ...
 public JSONArray verifyAndGenerate(ExamDetails ed) {
     ...
     PaymentDTO paymentDTO=new PaymentDTO(orderId, paymentId,signature);
     boolean isVerified = paymentFeignClient.verify(paymentDTO);//razorpayService.verifySignature(orderId, paymentId, signature);
